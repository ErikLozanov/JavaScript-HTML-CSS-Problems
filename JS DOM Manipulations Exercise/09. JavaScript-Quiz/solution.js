function solve() {
  ...
  function questions(e) {
    ...
    let sectionParent = clickedAnswer.parentElement.parentElement.parentElement.parentElement;
  ...
  } else if (sectionParent === document.querySelector("section:nth-of-type(2)")) {
...
} else if (sectionParent === document.querySelector("section:nth-of-type(3)")) {

  if (clickedAnswer.textContent === "The DOM is your source HTML") {
  } else if (clickedAnswer.textContent === "A programming API for HTML and XML documents") {
    rightAnswers++;
  }
